...
排版预设（--preset <name>）:
  ...
  onepage     OnePage 主题·暖白纸张（亮色，Obsidian 主题 OnePage v1.0.5 提炼，
              基于 Cupertino：暖白纸底 + 深青强调 + 标题彩色排版）
  onepage-dark OnePage 主题·暖棕·冷锚（暗色：暖棕底 + 冷青绿强调）
...
决策流程（用户只说"打印/导出这份文档"时）:
  ...
  2. 用户未指定风格时，先询问偏好: claude 亮色主题 / claude-dark 暗色 / onepage 暖白纸张 / onepage-dark 暖棕暗色 / phycat 讲义 / 默认简洁
